...
function F18AGPU(f18a) {
    ...
    // Lookup tables
    this.decoderTable = this.buildDecoderTable();
...
F18AGPU.prototype = {
    ...
    */
    ...
    opcodes: [
        new Opcode(0x0200, "LI", 8),
        new Opcode(0x0220, "AI", 8),
        new Opcode(0x0240, "ANDI", 8),
        new Opcode(0x0260, "ORI", 8),
        new Opcode(0x0280, "CI", 8),
        new Opcode(0x02a0, "STWP", 8),
        new Opcode(0x02c0, "STST", 8),
        new Opcode(0x02e0, "LWPI", 8),
        new Opcode(0x0300, "LIMI", 8),
        new Opcode(0x0340, "IDLE", 7),
        new Opcode(0x0360, "RSET", 7),
        new Opcode(0x0380, "RTWP", 7),
        new Opcode(0x03a0, "CKON", 7),
        new Opcode(0x03c0, "CKOF", 7),
        new Opcode(0x03e0, "LREX", 7),
        new Opcode(0x0400, "BLWP", 6),
        new Opcode(0x0440, "B", 6),
        new Opcode(0x0480, "X", 6),
        new Opcode(0x04c0, "CLR", 6),
        new Opcode(0x0500, "NEG", 6),
        new Opcode(0x0540, "INV", 6),
        new Opcode(0x0580, "INC", 6),
        new Opcode(0x05c0, "INCT", 6),
        new Opcode(0x0600, "DEC", 6),
        new Opcode(0x0640, "DECT", 6),
        new Opcode(0x0680, "BL", 6),
        new Opcode(0x06c0, "SWPB", 6),
        new Opcode(0x0700, "SETO", 6),
        new Opcode(0x0740, "ABS", 6),
        new Opcode(0x0800, "SRA", 5),
        new Opcode(0x0900, "SRL", 5),
        new Opcode(0x0a00, "SLA", 5),
        new Opcode(0x0b00, "SRC", 5),
        // New F18A opcodes
        new Opcode(0x0c00, "RET", 7),
        new Opcode(0x0c80, "CALL", 6),
        new Opcode(0x0d00, "PUSH", 6),
        new Opcode(0x0e00, "SLC", 5),
        new Opcode(0x0f00, "POP", 6),
        // ...
        new Opcode(0x1000, "JMP", 2),
        new Opcode(0x1100, "JLT", 2),
        new Opcode(0x1200, "JLE", 2),
        new Opcode(0x1300, "JEQ", 2),
        new Opcode(0x1400, "JHE", 2),
        new Opcode(0x1500, "JGT", 2),
        new Opcode(0x1600, "JNE", 2),
        new Opcode(0x1700, "JNC", 2),
        new Opcode(0x1800, "JOC", 2),
        new Opcode(0x1900, "JNO", 2),
        new Opcode(0x1a00, "JL", 2),
        new Opcode(0x1b00, "JH", 2),
        new Opcode(0x1c00, "JOP", 2),
        new Opcode(0x1d00, "SBO", 2),
        new Opcode(0x1e00, "SBZ", 2),
        new Opcode(0x1f00, "TB", 2),
        new Opcode(0x2000, "COC", 3),
        new Opcode(0x2400, "CZC", 3),
        new Opcode(0x2800, "XOR", 3),
        new Opcode(0x2c00, "XOP", 9),
        new Opcode(0x3000, "LDCR", 4),
        new Opcode(0x3400, "STCR", 4),
        new Opcode(0x3800, "MPY", 9),
        new Opcode(0x3c00, "DIV", 9),
        new Opcode(0x4000, "SZC", 1),
        new Opcode(0x5000, "SZCB", 1),
        new Opcode(0x6000, "S", 1),
        new Opcode(0x7000, "SB", 1),
        new Opcode(0x8000, "C", 1),
        new Opcode(0x9000, "CB", 1),
        new Opcode(0xa000, "A", 1),
        new Opcode(0xb000, "AB", 1),
        new Opcode(0xc000, "MOV", 1),
        new Opcode(0xd000, "MOVB", 1),
        new Opcode(0xe000, "SOC", 1),
        new Opcode(0xf000, "SOCB", 1)
    ],

    buildDecoderTable: function() {
        var decoderTable = [];
    ...
    run: function(cyclesToRun) {
        ...
        while (!this.cpuIdle && this.cycles - startCycles < cyclesToRun) {
            // Debugging
            if (this.PC == F18AGPU.DISASSM_START) { // && !this.disassmDone
                this.disassm = true;
                this.disassmCount = F18AGPU.DISASSM_LENGTH;
                this.disassmDone = true;
                this.log.info("* Disassembly start *");
                this.logRegs();
            }
            // Execute instruction
    ...
    execute: function(instruction) {
        ...
        if (opcode != null) {
            // if (!opcode.used) {
            //     this.log.info(((this.PC - 2) & 0xFFFF).toHexWord() + ": First " + opcode.id);
            //     opcode.used = true;
            // }
            if (this.disassm && this.disassmCount-- > 0) {
                this.log.info(((this.PC - 2) & 0xFFFF).toHexWord() + ": " + instruction.toHexWord() + " " + (opcode.id.padr(" ", 4)) + " " + this.getRegsString() + this.getInternalRegsString());
                if (this.disassmCount == 0) {
                    this.logRegs();
                    this.log.info("* Disassembly end *");
                }
            }
...
function Opcode(code, id, format) {
    this.code = code;
    this.id = id;
    this.format = format;
